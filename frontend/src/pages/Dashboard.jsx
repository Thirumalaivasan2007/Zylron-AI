                    ...
                    <div className="flex items-center gap-2 sm:gap-3 relative persona-selector" ref={personaRef}>
                        ...
                        {dropdownOpen && (
                            <div className="absolute top-12 right-0 w-56 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-xl overflow-hidden py-2 focus:outline-none transition-all z-50">
                                ...
                                <a href="https://github.com/Thirumalaivasan2007/Zylron-Agent-AI/releases/download/v3.0.0/Zylron%20AI%20Setup%203.0.0.exe" target="_blank" rel="noopener noreferrer" className="w-full flex items-center gap-3 px-4 py-3 text-sm text-cyan-500 hover:bg-cyan-500/5 dark:hover:bg-cyan-500/10 transition-all font-bold"><Monitor size={16} /> Download Desktop</a>
                                <div className="border-t border-gray-100 dark:border-gray-800 my-1"></div>
