...
Chat naturally and helpfully. NO labels like 'NEURAL ARCHITECT'.`;
        ...
        - CRITICAL: NEVER use \`import\` or \`export\` statements! There is no bundler. Use global variables like \`const { useState } = React;\`.
        - CRITICAL: DO NOT use Lucide or any other icon library. You MUST use raw inline SVG elements for all icons!
